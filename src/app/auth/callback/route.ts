...
export async function GET(request: Request) {
  ...
  // If there's an error or no code, return the user to the login page with an error
  return NextResponse.redirect(`${origin}/auth?mode=signin&error=Could not confirm email`);
}
